 ...
 * @author vickyaa
 * @date 1/5/24
 * @file UserStrategyExportDaoTest
 */
...
public class UserStrategyExportDaoTest {
    ...
    public void test_insert() {
        ...
        userStrategyExport.setuId("Uhdgvg766120d");
        ...
        userStrategyExport.setAwardContent("prize description");
    ...
    public void test_select() {
        UserStrategyExport userStrategyExport = userStrategyExportDao.queryUserStrategyExportByUId("Uhdgvg766120d");
